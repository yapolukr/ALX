...
for i in my_set:
    for j in dane:
        if (i == j[2]):
            ...
            list_miast.append(cyfra)
            list_sredn.append(sr)
            break

plt.bar(list_sredn, list_miast)
plt.show()

list = [illeWarszawa, illeSzczecin, illeBydgoszcz]
#print(list)
list1 = ['Warszawa', 'Szczecin', 'Bydgoszcz']

# plt.bar(list1, list)
# plt.show()

# #jaka srednya v randomnom gorode?
#
